...
§六"4.0.8 收尾内修"清单的**高 + 中**两档已全部落地，每档均带回归测试。低档位与"留待 4.1.0"各项**原样未动**。
...
**未做**:Docker harness(scripts/harness/run.sh,verify-keyboard.js §7 等)本机环境未跑——发布前建议在 Docker 环境补一轮真浏览器门禁。低档(O3-O6/D11/D13/D15/F2/I1 等)与 4.1.0 候选(F3/F4/F5/D14/D16/B4/F6)维持原处置。
