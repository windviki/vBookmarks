...
- 统一语言工具（`scripts/i18n.py`）：审计、缺失报告、LLM 批量翻译、verify 门禁。基准键从 75 增至 **345**（4.1.0 起 **684**），43 个语种全部对齐。
...
#   scripts/screenshots/shots-store.js   商店图两规格：1400×560 主题条带 + 1280×800 拼贴
