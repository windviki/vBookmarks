...
export function initDialogs(ctx = {}) {
    ...
    return { AlertDialog, ConfirmDialog, EditDialog, NewFolderDialog, SortDialog, GroupDialog, GroupPickDialog, CopyMoveDialog, BookmarkFolderPickDialog, anyOpen, activeEl, closeDialogs };
}
