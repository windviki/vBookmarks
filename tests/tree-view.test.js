...
describe('module API + startup wiring', () => {
    it('returns { generateTree, adaptBookmarkTooltips } and wires the startup getTree to generateTree', () => {
        const { treeView, chrome } = setup({});
        expect(Object.keys(treeView).sort()).toEqual(['adaptBookmarkTooltips', 'generateTree']);
