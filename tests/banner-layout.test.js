...
// The donation card centers its heart on the whole card and wraps its action
// row on narrow widths instead of clipping the last button.
...
describe('banner layout contract', () => {
    ...
    it('donation card centers the heart and lets its text/actions wrap', () => {
        expect(ruleBody(neatCss, '#donation-card {')).toContain('align-items: center');
